package com.ensa.springreact.web;

import com.ensa.springreact.domain.ProjectTask;
import com.ensa.springreact.service.ProjectTaskService;
...
public class ProjectTaskController {
    ...
    @PostMapping("")
    public ResponseEntity<?> addToBoard(@Valid @RequestBody ProjectTask projectTask, BindingResult result) {
        if (result.hasErrors()) {
